...
public class BookStoreModule : AbpModule
{
    ...
    public override void PreConfigureServices(ServiceConfigurationContext context)
    {
        ...
        if (!hostingEnvironment.IsDevelopment())
        {
            ...
            {
                serverBuilder.AddProductionEncryptionAndSigningCertificate("openiddict.pfx", "7275fae5-45b2-4013-a1eb-85cb97519c31");
            });
        }
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        //config ex permission
        //context.Services.Replace(ServiceDescriptor.Singleton<IStaticPermissionDefinitionStore, MyStaticPermissionDefinitionStore>());
        //context.Services.AddSingleton<IExtendedStaticPermissionDefinitionStore, MyStaticPermissionDefinitionStore>();
        Configure<PermissionManagementOptions>(options =>
        {
            options.IsDynamicPermissionStoreEnabled = true;
        });
        context.Services.Replace(ServiceDescriptor.Singleton<ILocalizableStringSerializer, FixedLocalizableStringSerializer>());
    ...
    private void ConfigureNavigationServices(IServiceCollection services)
    {
        ...
        {
            options.MenuContributors.Add(new BookStoreMenuContributor(services));
        });
    }
